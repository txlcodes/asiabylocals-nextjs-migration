import Hub, { generateMetadata as genMeta } from '@/app/[country]/itineraries/page';
...
export default async function Page({ params }: P) { return Hub({ params: withLang(params) } as any); }
