                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
                    <div className="col-span-1 lg:col-span-1">
                        <Link href="/" className="inline-block mb-4">
                            <img src="/logo.webp" alt="AsiaByLocals Logo" className="h-44 w-auto invert brightness-0" width={240} height={176} loading="lazy" />
                        </Link>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm font-bold text-gray-400">
                            <li><Link href="/explore" className="hover:text-white transition-colors">Explore All Destinations</Link></li>
