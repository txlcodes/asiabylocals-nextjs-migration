...
# Taj Mahal Entry Ticket 2026 – Skip-the-Line Official Admission for Foreigners
...
async function main() {
    const updatedTour = await prisma.tour.update({
        where: { id: 180 },
        data: {
            title: "Taj Mahal Entry Ticket 2026 – Skip-the-Line Official Admission for Foreigners",
            ...
            highlights: JSON.stringify([
                "Official Skip-the-Line Entry Ticket",
                "Instant PDF Delivery via WhatsApp",
                "Verified Government-Sourced Barcode",
                "Access to Main Mausoleum Included",
                "Flexible Entry via East or West Gate"
            ]),
            included: "Official Entry Ticket (Foreigner Class)\nAccess to Main Mausoleum\nInstant WhatsApp PDF Delivery\nSkip-the-Line Entry Access\n24/7 Local WhatsApp Support",
            notIncluded: "Professional Tour Guide\nHotel Pickup and Drop-off\nFood and Drinks\nGratuities",
            detailedItinerary: null,
            visitorInfo: null
        }
    });

    console.log("✅ Tour 180 title, highlights, and description fully updated.");
}
