        ...
        sections: [
          {
            ...
            table: {
              headers: ["Coast", "Calm and swimmable", "Rough and dangerous", "Places"],
              rows: [["South and west", "Nov-Apr", "May-Sep", "Bentota, Hikkaduwa, Unawatuna, Mirissa, Tangalle"], ["East and north", "May-Sep", "Oct-Jan", "Trincomalee, Pasikuda, Arugam Bay"]],
            },
            tourCard: {
              slug: "hikkaduwa-reef-scuba-diving-session",
              title: "Hikkaduwa Reef Scuba Diving Session",
