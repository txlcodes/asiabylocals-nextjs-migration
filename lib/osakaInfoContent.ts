    ...
    switch (slug) {
        ...
        sections: [
          ...
          },
          {
            ...
            icon: 'utensils',
            content: 'Deep-fried skewers of meat, vegetables, and seafood, dipped once in a shared sauce (double-dipping is a real faux pas at most stalls). Shinsekai\'s Janjan Yokocho alley is the classic place to eat it, under the neon glow of Tsutenkaku Tower.\n\nEat your way through the city\'s two great food districts with our [Dotonbori guide](/japan/osaka/dotonbori-guide) and [Shinsekai guide](/japan/osaka/shinsekai-guide), and fit it all together with the [3-day Osaka itinerary](/japan/osaka/osaka-3-day-itinerary). If you want to cook rather than eat, the [sushi class off Dotonbori](/japan/osaka/osaka-dotonbori-sushi-making-class-halal-vegan) runs vegan, halal and allergy menus, and the [gluten-free ramen and gyoza class](/japan/osaka/osaka-gluten-free-ramen-and-gyoza-class) makes both the noodles and the wrappers from scratch.',
            tourCard: {
              slug: 'osaka-food-tour',
              title: 'Osaka Street Food Tour: Takoyaki, Okonomiyaki & Local Flavor',
              description: 'A top-rated Osaka experience, bookable directly through AsiaByLocals.',
